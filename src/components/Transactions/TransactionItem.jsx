...
const TransactionItem = () => {
  return (
    <label
      ...
      className="card rounded-lg hover:bg-black/20"
    >
      <div className="card-body p-3">
        <div className="flex mb-1 items-center justify-center cursor-pointer">
          ...
          <div className="ml-auto flex flex-col">
            <span className="badge badge-success font-bold mb-2">
              Successful
            </span>
            <div className="flex">
